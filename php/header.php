<header id="header">
    <div class="container" id="header-cont-1">
        <picture>
            <source
                type="image/webp"
                srcset="img/webp/logo_main.webp"
            />
            <img
                alt="netmatters logo"
        ...
        <!-- Contact button -->
        <button class="grey hidden_button">
            <svg
                viewBox="0 0 1381 1075.597"
                xmlns="http://www.w3.org/2000/svg"
            >
    ...
    <aside>
        ...
        <div class="banner_hidden" id="banner-1b">
            ...
            <span></span><a href="#">Bespoke CRM</a> <span></span
            ><a href="#">Business Automation</a> <span></span
            ><a href="#">Software Integrations</a> <span></span
            ><a href="#">Mobile App Development</a> <span></span
            ><a href="#">Bespoke Databases</a> <span></span
            ><a href="#">Sharepoint Development</a> <span></span
            ><a href="#">Operational Systems</a> <span></span
        ...
        <div class="banner_hidden" id="banner-2b">
            ...
            <span></span><a href="#">Managed IT Support</a> <span></span
            ><a href="#">Business IT Support</a> <span></span
            ><a href="#">Office 365 for Business</a> <span></span
            ><a href="#">IT Consultancy</a> <span></span
            ><a href="#">Cloud Service Provider</a> <span></span
        ...
        <div class="banner_hidden" id="banner-3b">
            ...
            <span></span
            ><a href="#">Search Engine Optimisation<br />(SEO)</a>
            <span></span
            ><a href="#">Pay Per Click Advertising<br />(PPC)</a>
            <span></span
            ><a href="#">Conversion Rate Optimisation<br />(CRO)</a>
            <span></span><a href="#">Email Marketing</a> <span></span
            ><a href="#">Social Media Marketing</a> <span></span
            ><a href="#">Content Marketing</a>
        </div>

        <div class="banner_hidden" id="banner-4b">
            <h2>Our Telecoms Services</h2>
            <span></span><a href="#">Business Mobile</a> <span></span
            ><a href="#">Hosted VoIP Provider</a> <span></span
            ><a href="#">Business VoIP Systems</a> <span></span
            ><a href="#">Business Broadband</a> <span></span
            ><a href="#">Leased Lines Provider</a> <span></span
        ...
        <div class="banner_hidden" id="banner-5b">
            ...
            <span></span><a href="#">Branding & Design</a> <span></span
            ><a href="#">Mobile App Development</a> <span></span
        ...
        <div class="banner_hidden" id="banner-6b">
            ...
            <span></span><a href="#">PCI Compliance</a> <span></span
        ...
        <div class="banner_hidden" id="banner-7b">
            ...
            <span></span><a href="#">Skills Bootcamp</a> <span></span
